  ...
  return (
    <Html style={{ fontFamily: 'Blanka, Arial, sans-serif', backgroundColor: '#000', padding: '40px 0' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto', backgroundColor: '#000', padding: '40px', borderRadius: '30px', position: 'relative' }}>
        ...
        Excited for round two? Join us on Tuesday, September 19th for some rock painting fun! New faces are always welcome, so don't worry if you missed the first meeting. Come hang out and become a member!
        </p>
        ...
        <div style={{ padding: '10px 0', borderTop: '2px dashed #fff', borderBottom: '2px dashed #fff', marginTop: '20px', marginBottom: '20px' }}>
            ...
            <p style={{ color: '#ffffff' }}>
                <strong style={{ color: '#ffcd00' }}>1. When is our next meeting?{"   "}</strong>
                <span style={{ background: 'linear-gradient(45deg, #ffcd00, #ff1663)', borderRadius: '5px', padding: '3px 5px' }}>Tuesday, September 19th</span>
            </p>
            <p style={{ color: '#ffffff' }}>
                <strong style={{ color: '#ffcd00' }}>2. What will we do in the next meeting?{"   "}</strong> 
                We will be doing rock painting!
            </p>
            <p style={{ color: '#ffffff' }}>
                <strong style={{ color: '#ffcd00' }}>3. How can I join?{"   "}</strong> 
                Show up to our meetings and sign up on our membership form. A form link will be provided during the meeting. Everyone is welcome, even if you missed the first meeting.
            </p>
        </div>
